"""
Scoring is the same as 2048 Scoring, where score is a sum of merged tiles
...
class Vec():
    ...
    def __add__(self, d: "Vec") -> "Vec":
        return Vec(self.x + d.x, self.y + d.y)
...
class Board(GameElement):
        ...
        for x in range(len(values)):
            ...
            for y in range(len(values[x])):
                if values[x][y] == 0:
                    ...
                    x_values.append(Tile(Vec(x, y), values[x][y]))
    ...
    def slide(self, pos: "Vec", dir: "Vec"):
        ...
        while True:
            ...
            if self[new_pos] is None:
                ...
                self.tot_score += 2 * self[pos].value
    ...
    def _move_tile(self, old_pos: Vec, new_pos: Vec):
        old_tile = self.__getitem__(old_pos)
        old_tile.move_to(new_pos)
        self.__setitem__(new_pos, old_tile)
